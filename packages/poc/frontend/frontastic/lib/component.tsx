  ...
  return (
    <div
      className={classnames(
        `w-full ${data.tasticType === 'commercetools/ui/products/details' ? 'relative z-10' : ''} ${highlightClassNames(
          highlight,
        )} ${data.configuration.mobile ? 'block' : 'hidden'} ${data.configuration.tablet ? 'md:block' : 'md:hidden'} ${
