                  ...
                  {cart.lineItems.map((lineItem, i) => (
                    <li key={i} className="flex space-x-6 py-6">
                      <Image
                        ...
                        alt={lineItem.name}
                        className="h-40 w-40 flex-none cursor-pointer rounded-md  bg-transparent object-contain object-center"
                      ...
                      <div className="flex flex-col items-start justify-between space-y-4">
                        ...
                        <div className="flex w-full flex-col items-start space-y-2 divide-x-0">
                          <button
                            type="button"
